                      ...
                      {(provided ,snapshot) => (
                          ...
                          >
                              <h2 className='flex justify-between font-bold text-xl p-2 '>
                                ...
                                <span className='text-gray-500 bg-gray-200 rounded-full px-2 py-1 text-sm font-normal'>{!searchString ? todos.length: todos.filter(todo=> todo.title.toLowerCase().includes) }</span>
                              </h2> 
